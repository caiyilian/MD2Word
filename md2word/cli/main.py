...
def build_parser():
    ...
    parser.add_argument("input", nargs="?", help="Path to input file (.md or .docx)")
    ...
    parser.add_argument("--compare", nargs=2, metavar=("DOCX_A", "DOCX_B"),
                        help="Compare two docx files page by page (via image)")
    parser.add_argument("--dpi", type=int, default=200,
                        help="Image DPI for --to-images / --compare (default: 200)")
    return parser
...
def main():
    ...
    try:
        if args.compare:
            from docx2img import compare_docx
            compare_docx(args.compare[0], args.compare[1],
                         output_dir=args.output or "compare_output",
                         dpi=args.dpi)
        elif args.to_images:
            from docx2img import docx_to_images
